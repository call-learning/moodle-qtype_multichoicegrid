...
/**
 * Unit tests for the multichoicegrid onto image question definition class.
 *
...
class qtype_multichoicegrid_question_test extends basic_testcase {
    ...
    public function test_summarise_response() {
        ...
        $response = qtype_multichoicegrid_test_helper::create_full_right_response($dd);
    ...
    public function test_clear_wrong_from_response() {
        ...
        $response = qtype_multichoicegrid_test_helper::create_full_right_response($dd);
        $response[qtype_multichoicegrid_test_helper::get_fieldname_from_definition($dd, 0)] = 4;
    ...
    public function test_get_expected_data() {
        $dd = test_question_maker::make_question('multichoicegrid');
        $dd->start_attempt(new question_attempt_step(), 1);
        $expecteddata = qtype_multichoicegrid_test_helper::create_full_response_with_value($dd, PARAM_INT);
        $this->assertEquals(
            $expecteddata,
    ...
    public function test_get_correct_response() {
        $dd = test_question_maker::make_question('multichoicegrid');
        $dd->start_attempt(new question_attempt_step(), 1);
        $rightresponse = qtype_multichoicegrid_test_helper::create_full_right_response($dd);
    ...
    public function test_is_same_response() {
        ...
        $emptyresponse = qtype_multichoicegrid_test_helper::create_full_response_with_value($dd, '');
        ...
        $firstfieldname = qtype_multichoicegrid_test_helper::get_fieldname_from_definition($dd, 0);
    ...
    public function test_is_complete_response() {
        $dd = test_question_maker::make_question('multichoicegrid');
        $dd->start_attempt(new question_attempt_step(), 1);
        $fullresponse = qtype_multichoicegrid_test_helper::create_full_right_response($dd);
        $firstfieldname = qtype_multichoicegrid_test_helper::get_fieldname_from_definition($dd, 0);
    ...
    public function test_grading() {
        ...
        $allwrongresponse = qtype_multichoicegrid_test_helper::create_full_wrong_response($dd);
